...
[`@aws-sdk/client-dsql`](https://www.npmjs.com/package/@aws-sdk/client-dsql/v/3.772.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dsql@3.772.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NSXkskcPLKIyZBoztxEdcUBzeE6BaRA0++Mp5tEUl4LtDrOHke/zmeRRjLctBgek
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-dsql": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dsql@3.772.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dsql@3.772.0/index.min.mjs": "sha384-NSXkskcPLKIyZBoztxEdcUBzeE6BaRA0++Mp5tEUl4LtDrOHke/zmeRRjLctBgek"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-dsql/blob/refs/tags/3.772.0/LICENSE
```
